...
This is what TMP provides: two lightweight operations — [Context Match and Identity Match](/dist/docs/3.2.0-rc.4/trusted-match/context-and-identity) — that activate pre-negotiated packages across any surface, with structural privacy guarantees and sub-50ms latency.
