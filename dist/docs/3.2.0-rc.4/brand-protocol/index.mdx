...
<CardGroup cols={2}>
  ...
  <Card title="For publishers / sellers" icon="store" href="/dist/docs/3.2.0-rc.4/brand-protocol/seller-setup">
    How to publish seller identity, property relationships, and signing keys.
  </Card>
  <Card title="Rights licensing" icon="film" href="/dist/docs/3.2.0-rc.4/brand-protocol/walkthrough-rights-licensing">
