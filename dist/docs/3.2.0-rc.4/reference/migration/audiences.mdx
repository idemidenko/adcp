...
description: "Migrate AdCP audiences from beta.3 to rc.1. Promotes external_id to a required top-level field on AudienceMember with stable buyer-assigned identifiers."
"og:title": "AdCP — Migrating audiences"
testable: true
---
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-rc.4/core/audience-member.json",
...
**Related:** [Brand identity](/dist/docs/3.2.0-rc.4/reference/migration/brand-identity) | [Optimization goals](/dist/docs/3.2.0-rc.4/reference/migration/optimization-goals) | [AdCP 3.0 overview](/dist/docs/3.2.0-rc.4/reference/whats-new-in-v3)
