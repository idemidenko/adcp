...
description: "Migrate AdCP channels from v2 to v3. Maps v2's 9 format-oriented channels to v3's 20 planning-oriented media channels with field-by-field examples."
"og:title": "AdCP — Migrating channels"
testable: true
---
