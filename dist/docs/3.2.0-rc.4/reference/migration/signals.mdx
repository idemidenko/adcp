...
description: "Migrate AdCP signals from beta.3 to rc.1. Covers deliver_to flattening, structured pricing options, and simplified usage reporting fields."
"og:title": "AdCP — Migrating signals"
testable: true
---
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-rc.4/core/signal-pricing-option.json",
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-rc.4/account/report-usage-request.json",
...
<Card title="Signals Protocol" icon="arrow-right" href="/dist/docs/3.2.0-rc.4/signals/overview">
  Full reference for signal discovery, activation, usage reporting, and pricing models.
</Card>

---

**Related:** [Pricing](/dist/docs/3.2.0-rc.4/reference/migration/pricing) | [Optimization goals](/dist/docs/3.2.0-rc.4/reference/migration/optimization-goals) | [AdCP 3.0 overview](/dist/docs/3.2.0-rc.4/reference/whats-new-in-v3)
