...
description: "Migrate AdCP attribution windows from v2 to v3. Replaces integer day counts with structured Duration objects and adds required attribution model field."
"og:title": "AdCP — Migrating attribution windows"
testable: true
---
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-rc.4/core/attribution-window.json",
  "post_click": {
    "interval": 7,
    "unit": "days"
  },
