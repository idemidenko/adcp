...
description: "Migrate AdCP brand identity from beta.3 to rc.1. Replaces inline brand_manifest objects with BrandRef references resolved via brand.json or the community registry."
"og:title": "AdCP — Migrating brand identity"
testable: true
---
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-rc.4/core/brand-ref.json",
...
<Card title="Brand identity" icon="arrow-right" href="/dist/docs/3.2.0-rc.4/brand-protocol/brand-json">
  Full reference for brand.json variants, the brand registry, and BrandRef resolution.
</Card>

---

**Related:** [Channels](/dist/docs/3.2.0-rc.4/reference/migration/channels) | [Catalogs](/dist/docs/3.2.0-rc.4/reference/migration/catalogs) | [Brand Protocol](/dist/docs/3.2.0-rc.4/brand-protocol) | [AdCP 3.0 overview](/dist/docs/3.2.0-rc.4/reference/whats-new-in-v3)
