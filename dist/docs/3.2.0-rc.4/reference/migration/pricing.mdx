...
description: "Migrate AdCP pricing from v2 to v3. Covers field renames, the hard constraint vs soft hint separation, and updated pricing option schemas."
"og:title": "AdCP — Migrating pricing"
testable: true
---
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-rc.4/pricing-options/price-guidance.json",
  "p25": 8.50,
  "p50": 15.00,
  "p75": 18.00,
  "p90": 22.00
