...
description: "AdCP Content Standards enable privacy-preserving brand suitability evaluation for AI-generated and ephemeral content that cannot leave publisher infrastructure."
"og:title": "AdCP — Content Standards"
...
- [Brand identity](/dist/docs/3.2.0-rc.4/brand-protocol/brand-json) - Brand identity that can link to standards agents
