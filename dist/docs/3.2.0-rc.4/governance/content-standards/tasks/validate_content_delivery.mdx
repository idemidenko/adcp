...
description: "validate_content_delivery batch-evaluates delivery records against content safety policies asynchronously in AdCP."
"og:title": "AdCP — validate_content_delivery"
---
...
Content artifacts are separate from delivery metrics. Use [`get_media_buy_artifacts`](/dist/docs/3.2.0-rc.4/governance/content-standards/tasks/get_media_buy_artifacts) to retrieve content for validation:
...
**Schema**: [validate-content-delivery-request.json](https://adcontextprotocol.org/schemas/3.2.0-rc.4/content-standards/validate-content-delivery-request.json)
...
**Schema**: [validate-content-delivery-response.json](https://adcontextprotocol.org/schemas/3.2.0-rc.4/content-standards/validate-content-delivery-response.json)

### Success Response

```json
{
  "$schema": "/schemas/3.2.0-rc.4/content-standards/validate-content-delivery-response.json",
  "status": "completed",
  "summary": {
    "total_records": 1000,
    "passed_records": 950,
