...
description: "Integrate AdCP Sponsored Intelligence into your AI platform. Discover brand agents, render standard UI components, manage session lifecycle, handle consent flows, and hand off to ACP for commerce."
"og:title": "AdCP — Implementing SI Hosts"
---
...
- Handle standard error codes: `SESSION_NOT_FOUND`, `SESSION_TERMINATED`, `RATE_LIMITED`
- Handle SI-specific error codes: `offer_unavailable`, `capability_unsupported`
...
- Join the [community Slack](/dist/docs/3.2.0-rc.4/community/joining-slack) for implementation support
