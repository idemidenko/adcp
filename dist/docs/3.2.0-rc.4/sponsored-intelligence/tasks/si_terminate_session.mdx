...
sequenceDiagram
    ...
    B->>H: { acp_handoff: { checkout_url, checkout_token/payload } }
    H->>A: Initiate checkout with token/payload
    A->>H: Checkout flow
```
