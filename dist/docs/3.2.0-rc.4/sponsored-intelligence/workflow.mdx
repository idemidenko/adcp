...
- **Offering catalog** — promotions, services, and seasonal campaigns for [SI Chat Protocol](/dist/docs/3.2.0-rc.4/sponsored-intelligence/si-chat-protocol) brand experience handoffs

<Tip>
Improving your ads means improving what you push in — catalogs, conversion events, brand identity, and [content standards](/dist/docs/3.2.0-rc.4/governance/content-standards/index). Include detailed descriptions, multiple images, and structured attributes in catalogs. Push conversion events so the platform knows what works. The platform generates ads from all of this data — richer input produces better output.
</Tip>
...
```json
{
  "idempotency_key": "550e8400-e29b-41d4-a716-446655442012",
  "buying_mode": "brief",
...
The seller returns products matching the brief. For catalog-driven products, sellers may include `catalog_match` showing which catalog items are eligible. See the [product spectrum](/dist/docs/3.2.0-rc.4/sponsored-intelligence/product-spectrum) for the full range of product types.
...
See [measurement](/dist/docs/3.2.0-rc.4/sponsored-intelligence/measurement) for metric definitions and conversion tracking.
