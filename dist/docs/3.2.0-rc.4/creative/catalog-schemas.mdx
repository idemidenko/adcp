...
description: "AdCP catalog item schemas define required fields and structures for job, hotel, vehicle, flight, real estate, and other vertical data feeds."
"og:title": "AdCP — Catalog item schemas"
testable: true
---
...
All vertical items share a common pattern: a unique ID field, core display fields, an optional `assets` array for [typed creative asset pools](/dist/docs/3.2.0-rc.4/creative/catalogs#typed-catalog-assets), an optional `tags` array for filtering, and an `ext` object for vendor-specific extensions. **Conversion events** listed for each vertical are the standard event names used for [attribution](/dist/docs/3.2.0-rc.4/media-buy/conversion-tracking) when an ad drives action on a catalog item.
...
| `assets` | OfferingAssetGroup[] | [Typed creative asset pools](/dist/docs/3.2.0-rc.4/creative/catalogs#typed-catalog-assets) (landscape, vertical, square, logo, video) |
...
**Schema**: [`/schemas/core/job-item.json`](https://adcontextprotocol.org/schemas/3.2.0-rc.4/core/job-item.json)
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-rc.4/core/job-item.json",
...
**Schema**: [`/schemas/core/hotel-item.json`](https://adcontextprotocol.org/schemas/3.2.0-rc.4/core/hotel-item.json)
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-rc.4/core/hotel-item.json",
...
**Schema**: [`/schemas/core/vehicle-item.json`](https://adcontextprotocol.org/schemas/3.2.0-rc.4/core/vehicle-item.json)
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-rc.4/core/vehicle-item.json",
...
**Schema**: [`/schemas/core/flight-item.json`](https://adcontextprotocol.org/schemas/3.2.0-rc.4/core/flight-item.json)
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-rc.4/core/flight-item.json",
...
**Schema**: [`/schemas/core/real-estate-item.json`](https://adcontextprotocol.org/schemas/3.2.0-rc.4/core/real-estate-item.json)
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-rc.4/core/real-estate-item.json",
...
**Schema**: [`/schemas/core/education-item.json`](https://adcontextprotocol.org/schemas/3.2.0-rc.4/core/education-item.json)
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-rc.4/core/education-item.json",
...
**Schema**: [`/schemas/core/destination-item.json`](https://adcontextprotocol.org/schemas/3.2.0-rc.4/core/destination-item.json)
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-rc.4/core/destination-item.json",
...
**Schema**: [`/schemas/core/app-item.json`](https://adcontextprotocol.org/schemas/3.2.0-rc.4/core/app-item.json)
...
```json
{
  "$schema": "https://adcontextprotocol.org/schemas/3.2.0-rc.4/core/app-item.json",
