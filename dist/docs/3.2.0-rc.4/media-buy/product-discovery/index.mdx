...
|---|---|---|
| Browse or filter published offers | [`list_products`](/dist/docs/3.2.0-rc.4/media-buy/task-reference/list_products) | [`buy_products`](/dist/docs/3.2.0-rc.4/media-buy/task-reference/buy_products) |
...
| Ask the seller to build or negotiate a plan | [`request_proposals`](/dist/docs/3.2.0-rc.4/media-buy/task-reference/request_proposals) | Finalize with `refine_proposals`, then [`accept_proposal`](/dist/docs/3.2.0-rc.4/media-buy/task-reference/accept_proposal) |
...
See [`list_products` wholesale feed webhooks](/dist/docs/3.2.0-rc.4/media-buy/task-reference/list_products#wholesale-feed-webhooks)
...
envelope use [`control_media_buy`](/dist/docs/3.2.0-rc.4/media-buy/task-reference/control_media_buy).
...
See [Proposal negotiation](/dist/docs/3.2.0-rc.4/media-buy/product-discovery/proposal-negotiation)
...
through [`sync_catalogs`](/dist/docs/3.2.0-rc.4/media-buy/task-reference/sync_catalogs).
...
[3.1 → 3.2 migration guide](/dist/docs/3.2.0-rc.4/reference/migration/3-1-to-3-2). Keep this
...
- [Media buy lifecycle](/dist/docs/3.2.0-rc.4/media-buy/media-buys/lifecycle) — commitment,
  creative supply, control, and delivery
- [Media products](/dist/docs/3.2.0-rc.4/media-buy/product-discovery/media-products) — product,
  pricing, targeting, and format semantics
- [Brief expectations](/dist/docs/3.2.0-rc.4/media-buy/product-discovery/brief-expectations) —
  what belongs in prose versus structured criteria
- [Task reference](/dist/docs/3.2.0-rc.4/media-buy/task-reference/) — compact lifecycle request
