...
not proposal conversations. See [Product discovery and planning](/dist/docs/3.2.0-rc.4/media-buy/product-discovery/)
for both paths.
...
See [Trusted Match Protocol](/dist/docs/3.2.0-rc.4/trusted-match) for the privacy architecture
...
- [Product discovery and planning](/dist/docs/3.2.0-rc.4/media-buy/product-discovery/) — choose
  published offers, wholesale mirroring, or proposals
- [Proposal negotiation](/dist/docs/3.2.0-rc.4/media-buy/product-discovery/proposal-negotiation)
  — implement immutable revisions and holds
- [Media buy lifecycle](/dist/docs/3.2.0-rc.4/media-buy/media-buys/lifecycle) — state,
  creatives, controls, and delivery
- [3.1 → 3.2 migration](/dist/docs/3.2.0-rc.4/reference/migration/3-1-to-3-2) — isolate the
