...
The [Signals Protocol](/dist/docs/3.2.0-rc.4/signals/overview) connects many types of companies. This guide shows how each fits in, what they build, and where to go next.
...
**Next steps**:
- [Data provider guide](/dist/docs/3.2.0-rc.4/signals/data-providers) — complete walkthrough of published signal definitions
- [Signals specification](/dist/docs/3.2.0-rc.4/signals/specification) — protocol details
- [S3: Signals specialist module](/dist/docs/3.2.0-rc.4/learning/specialist/signals) — hands-on lab with sandbox signal agent
...
You sell sponsored products and display inventory. This uses the [Media Buy Protocol](/dist/docs/3.2.0-rc.4/media-buy/index) — declare your properties in `adagents.json`, build a sales agent, handle `get_products` and `create_media_buy`.
...
**Closed-loop measurement**: Your purchase data also enables attribution. When a campaign targets your shopper signals and the consumer buys the advertised product on your marketplace, you can measure that conversion directly. Use [`sync_event_sources`](/dist/docs/3.2.0-rc.4/media-buy/task-reference/sync_event_sources) to register your purchase event feed with buyer agents, then [`log_event`](/dist/docs/3.2.0-rc.4/media-buy/task-reference/log_event) to report conversions. This closes the loop from targeting to measurement without relying on third-party attribution — a significant advantage for retail media.

**Next steps**:
- [Commerce media guide](/dist/docs/3.2.0-rc.4/media-buy/commerce-media) — maps retail concepts to AdCP
- [Data provider guide](/dist/docs/3.2.0-rc.4/signals/data-providers) — how to publish your signal definitions
- [Conversion tracking](/dist/docs/3.2.0-rc.4/media-buy/conversion-tracking/index) — closed-loop measurement with `sync_event_sources` and `log_event`
- [Seller integration guide](/dist/docs/3.2.0-rc.4/building/operating/seller-integration) — building your sales agent
...
**Next steps**:
- [Data provider guide](/dist/docs/3.2.0-rc.4/signals/data-providers) — add signals to your existing adagents.json
- [Publisher/seller track](/dist/docs/3.2.0-rc.4/learning/tracks/publisher) — build your sales agent (if you haven't already)
- [S3: Signals specialist module](/dist/docs/3.2.0-rc.4/learning/specialist/signals) — understand the buyer's perspective
...
**What doesn't fit (yet)**: Your core identity resolution service — matching Device A to Person B — is infrastructure that enhances other signals, not a signal itself. AdCP doesn't yet have a protocol for identity resolution as a service. This is on the [roadmap](/dist/docs/3.2.0-rc.4/reference/roadmap).
...
**Next steps**:
- [Data provider guide](/dist/docs/3.2.0-rc.4/signals/data-providers) — publish your signal definitions
- [Platform/intermediary track](/dist/docs/3.2.0-rc.4/learning/tracks/platform) — if you're building infrastructure that connects data to platforms
...
**Next steps**:
- [Data provider guide](/dist/docs/3.2.0-rc.4/signals/data-providers) — signal definition structure
- [Platform/intermediary track](/dist/docs/3.2.0-rc.4/learning/tracks/platform) — building MCP-based infrastructure
- [Signals specification](/dist/docs/3.2.0-rc.4/signals/specification) — protocol conformance requirements
...
**Next steps**:
- [Buyer/brand track](/dist/docs/3.2.0-rc.4/learning/tracks/buyer) — media buying with AdCP
- [Data provider guide](/dist/docs/3.2.0-rc.4/signals/data-providers) — publish your proprietary signals
- [S3: Signals specialist module](/dist/docs/3.2.0-rc.4/learning/specialist/signals) — hands-on signal discovery and activation
...
**Next steps**:
- [Platform/intermediary track](/dist/docs/3.2.0-rc.4/learning/tracks/platform) — MCP server architecture
- [Signals specification](/dist/docs/3.2.0-rc.4/signals/specification) — destination and deployment model
- [Industry landscape](/dist/docs/3.2.0-rc.4/building/concepts/industry-landscape) — how AdCP fits alongside other standards
- [Working group](/dist/docs/3.2.0-rc.4/community/working-group) — help shape clean room integration patterns
